...
//                self.siteWebView!.frame = CGRect(x: 0.0, y: 0.0, width: screenSize.height, height: (screenSize.width - 0)) //98
    ...
    @IBAction func allocateTimeAction(_ sender: UIButton?) {
        ...
        customPickerView.selectRow(hoursPickerValues.index(of: setHours)!, inComponent: 0, animated: true)
        customPickerView.selectRow(minutesPickerValues.index(of: setMinutes)!, inComponent: 1, animated: true)
